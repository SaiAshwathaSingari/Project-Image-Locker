		...
		<div className="min-h-screen w-full bg-gradient-to-br from-[#799EFF] to-[#FEFFC4] flex items-center justify-center p-4">
			<div className="flex w-full max-w-4xl bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden">
				<div className="flex-1 relative overflow-hidden">
					<img className="w-full h-full object-cover" src="./images/signup2.avif" alt="signup" />
				</div>
				<div className="flex-1 p-8 space-y-6 flex flex-col justify-center">
					...
					<h2 className="text-2xl font-semibold text-[#2c444e] text-center mb-6">Create Account</h2>
					<input 
						type="text" 
					...
					<button className="w-full py-3 px-6 bg-white hover:bg-[#FEFFC4] border border-gray-300 rounded-lg shadow-md transition-all duration-200 flex items-center justify-center space-x-3" onClick={googleAuth}>
						<img src="./images/google.png" alt="google icon" className="w-6 h-6" />
						<span className="text-[#2c444e] font-medium">Sign up with Google</span>
					</button>
					<p className="text-center text-[#2c444e]">
						Already Have Account ? <Link to="/login" className="text-[#799EFF] hover:text-[#FFDE63] font-medium transition-colors duration-200">Log In</Link>
					</p>
				</div>
			</div>
		</div>
